...
const Queue = require('./queueFlowers.js');
...
socket.emit('join', companyID); //put them in a private room that has their store name

let vendorPayload = { clientID: companyID, event: 'delivered'}; //set payload for get-all request
